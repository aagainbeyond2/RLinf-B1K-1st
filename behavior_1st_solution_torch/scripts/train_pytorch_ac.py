...
use activation checkpoint but not kv transform
"""
...
def main():
    ...
    # Activation Checkpointing (AC) Setup
    # 使用 NO_REENTRANT 模式，这是 FSDP 推荐的模式，开销更小且兼容性更好
    ...
    if rank == 0:
        logging.info("⚡️ Applying Activation Checkpointing to Transformer Layers...")
    apply_activation_checkpointing(
        model, 
