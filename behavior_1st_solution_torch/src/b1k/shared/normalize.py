...
Supports per-timestamp normalization.
"""
...
class NormStats:
    ...
    # Averaged correlation matrices (for analysis)
    # Spatial correlation: correlation between action dimensions (averaged across timesteps)
    # Shape: [action_dim, action_dim]
    action_correlation_spatial: numpydantic.NDArray | None = None
    
    # Temporal correlation: correlation across time (averaged across dimensions)
    # Shape: [action_horizon, action_horizon]
    action_correlation_temporal: numpydantic.NDArray | None = None
