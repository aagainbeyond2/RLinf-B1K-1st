...
_CONFIGS = [
    ...
    TrainConfig(
        ...
        data=LeRobotB1KDataConfig(
            ...
            base_config=DataConfig(
                prompt_from_task=False,  # No text prompts for PI_BEHAVIOR
                behavior_dataset_root="/data/PA/yejiaquan/data/behavior_224_rgb",
                use_per_timestamp_norm=True,  # Enable per-timestamp normalization
                task_type="task_cls_1",  # YYJJQQ
            ),
            use_delta_joint_actions=True,
            use_fast_tokenization=True,  # Enable FAST tokenization in data pipeline
        ),
        ...
        assets_base_dir="/ms/PA/yejiaquan/b1k_models/assets",
        checkpoint_base_dir="/ms/PA/yejiaquan/b1k_models/checkpoints_debug",
        num_workers=8,
        save_interval=500,
        keep_period=2000,
        grad_accum_steps=32,
